...
function get_mutation_fcts(code__html, document, node_map){
    ...
    function removeDependency(code_dependency){
        ...
        */
        ...
        function apply_dom_changes(){
            if( (code_dependency||{}).constructor !== CodeInfo ) {
    ...
    function insertDependencyBefore(code, code__insertion_point){
        ...
        function apply_dom_changes(){
            ...
            var anchor_node = search_anchor_node(code__insertion_point, code.mime_type);
        ...
        var anchor_code = (function(){
            if( ! code ) {
                return (
                    code__html
                    .dependencies
                    .filter(function(code_dependency){
                        return code_dependency.mime_type === mime_type;
                    })
                    .slice(-1)[0]
                );
            }
