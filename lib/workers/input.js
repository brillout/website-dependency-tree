...
function validate_input(code){
    ...
    if( code._input.path || code._input.location.path)
    ...
    assert( ! code._input.includer || code._input.includer.location.disk.directory || code._input.includer.location.internet.url );
}
