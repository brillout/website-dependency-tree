...
function assign_input(code, done){
...
function validate_input(code, done){
    if( code._input.uri )
...
function fetch_source_code(code, done){
...
function deduce_mime_type(code, done){
