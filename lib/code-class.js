...
function Location(code_info){
    ...
    this.disk.path_relative =
        this.uri
            && ! is_url(this.uri, code_info.includer)
            && get_path_relative(this.disk.path, code_info.includer)
        || null ;
    ...
    this.disk.directory =
        ...
        || code_info.includer
            && code_info.includer.location.disk.directory ;
    ...
    function get_url(uri, includer){
        var info__as_url = parse_url(uri);
    ...
    function get_path_relative(path_absolute, includer){
        if( !includer ) return null;
        assert( includer.location.disk.directory );
        return require('path').relative(includer.location.disk.directory, path_absolute);
    }
