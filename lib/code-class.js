// Code Object Class
// - every piece of code is hold by an instance of this Code Class
// - cumulates information about the holded piece of code
...
Code.prototype.execute_pipeline = function(callback){
    ...
    function go_through(i){
        ...
        var timeout = setTimeout(function(){
            ...
            throw new Error('`done()` not called within '+TIMEOUT+ 'ms when going through '+(i+1)+'th pipline worker '+worker_info+' on '+code.id);
        },TIMEOUT);
